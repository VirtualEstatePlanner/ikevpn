...
docker create --privileged --rm --volumes-from ikev2-vpn-server -e "HOST=$HOST" -e "CONN_NAME=$CONN_NAME" -e "PROFILE_NAME=$PROFILE_NAME" georgegeorgulasiv/ikevpn generate-mobileconfig > ikev2-vpn.mobileconfig
